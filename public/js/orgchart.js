...
class Pages {
	...
	jobsPage() {
		...
		var loader = '<div style="width:100%;text-align:center; padding:40px"><img style="width:30px" src="/public/img/new_loading2.gif"/><br><br><span style="font-size:10pt">Searching your data...</span></div>';
...
class PageContents {
	...
	logIn() {
		...
		if (sessionStorage["email"] == "" || sessionStorage["password"] == "") {
			...
			var loader =
				'<div style="width:100%;text-align:center; padding:40px"><img style="width:30px" src="/public/img/new_loading2.gif"/>';
		...
		if (
			...
			try {
				...
				document.getElementById("signup_form_content").innerHTML =
					'<span style="font-size:18pt;font-weight: 500;">Creating your account...</span><br><br><br><div style="width:100%;text-align:center; padding:40px"><img style="width:30px" src="/public/img/new_loading2.gif"/><br><br></div>';
	...
	sendResetLink() {
		...
		if (sessionStorage["email"] == "") {
			...
			document.getElementById("reset_password_form_content").innerHTML =
				'<span style="font-size:18pt;font-weight: 500;">Finding your account...</span><br><br><br><div style="width:100%;text-align:center; padding:40px"><img style="width:30px" src="/public/img/new_loading2.gif"/><br><br></div>';
...
class Query {
	...
	ifYouCanSetupLoadersinTheRightSide() {
		var loader =
			'<div style="width:100%;text-align:center; padding:40px"><img style="width:30px" src="/public/img/new_loading2.gif"/><br><br><span style="font-size:10pt">Searching ...<br>Companies with > 10k employees may take ~20 seconds!</span></div>';
		try {
			document.getElementById(
				"right_search_results_people_companies_orgcharts"
			).innerHTML = loader;
		...
		if ((user_input == "count_query") & (response["status"] != "incomplete")) {
			...
			if (response["status"] == "success" || response["status"] == "blank") {
				...
				if (response["query_status"] == "unauthorized") {
					...
					var loader =
						'<div style="width:100%;text-align:center; padding:40px"><img style="width:30px" src="/public/img/new_loading2.gif"/><br><br><span style="font-size:10pt">Searching your data...</span></div>';
	...
	fetchQueryShowResults(user_input) {
		...
		var loader2 = '<div style="width:100%;text-align:center; padding:40px"><img style="width:30px" src="/public/img/new_loading2.gif"/></div>';
		if (user_input === undefined ||user_input == "load_data_without_loading_tokens") {
			...
			if (sessionStorage["current_focus"] == "orgcharts") {
				document.getElementById("cost_of_credits_org_chart").innerHTML =
					'<div style="width:100%;text-align:center; padding:10px"><img style="width:30px;" src="/public/img/new_loading2.gif"/></div> ';
				if (
					sessionStorage["selectFunctionsTreeFunctionsRootItem"] != "" ||
					sessionStorage["selectFunctionsTreeFunctionsItem"] != "" ||
					sessionStorage["selectGradesItem"] != ""
...
class UtilityFunctions {
	...
	openHelpModal() {
		...
		document.getElementById("helper_image").innerHTML =
			'<img style="width:600px;" src="/public/img/load_org_chart.gif"/>';
	...
	swapHelper(user_input) {
		...
		if (help == "load_org_chart") {
			...
			document.getElementById("helper_image").innerHTML =
				'<img style="width:600px;" src="/public/img/fetch_positions.gif"/>';
			document.getElementById("helper_description").innerHTML =
			...
			document.getElementById("helper_image").innerHTML =
				'<img style="width:600px;" src="/public/img/similar_people_similar_companies.gif"/>';
			document.getElementById("helper_description").innerHTML =
				'Right-click on a position and select "Fetch similar people in similar companies"';
		} else if (help == "find_people_company") {
			document.getElementById("helper_image").innerHTML =
				'<img style="width:600px;" src="/public/img/search_people_companies.gif"/>';
			document.getElementById("helper_description").innerHTML =
			...
			document.getElementById("helper_image").innerHTML =
				'<img style="width:600px;" src="/public/img/share.gif"/>';
			document.getElementById("helper_description").innerHTML =
			...
			document.getElementById("helper_image").innerHTML =
				'<img style="width:600px;" src="/public/img/make_payment.gif"/>';
			document.getElementById("helper_description").innerHTML =
	...
	getLinkedinUrl(person_name, job_title, url, image) {
		...
		// document.getElementById("linkedin_profile").innerHTML = '<img src="/public/img/linkedin-icon-png-circle-2.png" style="height:20px; width:20px;margin-bottom:5px">'
