            ...
            <div style={{display: 'table-cell', width: '70%', backgroundColor: 'white', padding: 20}}>
                ...
                <div id="password_reset_link_form_content">
                    ...
                    <div className="row">
                        ...
                        <input id="password" type="password" className="form-control-custom" placeholder="New password" oninput="new SessionStorageUpdates().updatePassword(this)" /><br />
                        </div>
                        <div className="col-sm-12">
                        <input id="confirm_password" type="password" className="form-control-custom" placeholder="Confirm new password" oninput="new SessionStorageUpdates().updatePasswordConfimation(this)" /><br />
                        </div>
                    </div>
                    <br />
                    <div style={{width: '100%', textAlign: 'center', position: 'relative', padding: 20}}>
                        <div className="form_button" style={{margin: 'auto', position: 'absolute', left: 0, right: 0, top: 0, bottom: 0}} onClick="new PasswordReset().confirmNewPassword()">Confirm</div>
                    </div>
                    </div>
                    <div id="password_reset_link_error" style={{marginTop: 20}} />
                </div>
                </div>
            </div>
        ...
        <div className="mobi">
            ...
            <div style={{backgroundColor: 'white', padding: 20}}>
                ...
                <div id="password_reset_link_form_content_mobi">
                    ...
                    <div id="password_reset_link_error_mobi" style={{marginTop: 20}} />
                </div>
                </div>
            </div>
            <div className="signup_lateral" style={{padding: 20, textAlign: 'left'}}>
                ...
                <i id="testimonial_quote">Arxena helps me map in minutes large F100 accounts saving me hours of manual work for resourcing projects.</i>
                <span style={{fontSize: '13pt'}}><br /><br /><strong style={{fontWeight: 500}} id="testimonial_name">John Calvani</strong> | </span>
                <span id="testimonial_title" style={{fontSize: '13pt'}}>Manager - Consulting</span>
                <br />
                <img id="linkedin_logo" src="/public/img/linkedin_logo.png" onClick="window.open('https://www.linkedin.com/in/mannanpacha1988')" style={{height: 20, cursor: 'pointer'}} />
                <div style={{textAlign: 'right'}}>
